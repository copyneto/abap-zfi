class ZCLFI_CX_FMT_CONTABI_LANCAMENT definition
  public
...
public section.
  ...
  data STANDARD type ZCLFI_EXCHANGE_FAULT_DATA read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLFI_EXCHANGE_FAULT_DATA optional
...
CLASS ZCLFI_CX_FMT_CONTABI_LANCAMENT IMPLEMENTATION.
