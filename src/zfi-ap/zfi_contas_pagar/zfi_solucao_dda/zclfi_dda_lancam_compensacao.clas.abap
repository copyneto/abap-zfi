CLASS zclfi_dda_lancam_compensacao DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zclfi_dda_lancam_compensacao IMPLEMENTATION.
  ...
  METHOD mount_item.
    ...
    LOOP AT lt_item ASSIGNING <fs_s_item>.
      ...
      IF <fs_s_item>-hkont IS NOT INITIAL.
        FREE lv_value.
      ...
      IF <fs_s_item>-newko IS NOT INITIAL.
        FREE lv_value.
        lv_value = <fs_s_item>-hkont.

        "Conta ou matchcode para o item seguinte
        set_value_ftpost( iv_type   = 'P'
                            iv_screen = lv_tela
                            iv_field  = 'RF05A-NEWKO'
                            iv_value  = lv_value ).
      ENDIF.
      ...
      IF <fs_s_item>-zuonr IS NOT INITIAL.
        FREE lv_value.
