@AbapCatalog.sqlViewName: 'ZVFI_ARQAGRPSTAT'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'Status arquivo agrupamento'
@ObjectModel.resultSet.sizeCategory: #XS
@ObjectModel.dataCategory: #TEXT
define view ZI_FI_VH_AGRUPA_ARQ_STATUS
    ...
    and _Text.ddlanguage     = $session.system_language
{
  ...
  key cast(LEFT( domvalue_l, 1 ) as ze_fi_status_arq_agrupa ) as StatusId,
...
where
      domname  = 'ZD_FI_STATUS_ARQ_AGRUPA'
  and as4local = 'A'
