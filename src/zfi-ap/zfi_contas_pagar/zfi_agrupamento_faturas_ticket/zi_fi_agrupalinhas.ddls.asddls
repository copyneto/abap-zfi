...
@EndUserText.label: 'Linhas do arquivo de agrupamento faturas'
define view entity ZI_FI_AGRUPALINHAS
  as select from ztfi_agruplinhas

  association        to parent ZI_FI_AGRUPAFATURAS  as _Arquivo
    on $projection.IdArquivo = _Arquivo.IdArquivo
