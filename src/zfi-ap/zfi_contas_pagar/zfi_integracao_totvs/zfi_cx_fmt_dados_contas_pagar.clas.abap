class ZFI_CX_FMT_DADOS_CONTAS_PAGAR definition
  public
...
public section.
  ...
  data STANDARD type ZFI_EXCHANGE_FAULT_DATA read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZFI_EXCHANGE_FAULT_DATA optional
...
CLASS ZFI_CX_FMT_DADOS_CONTAS_PAGAR IMPLEMENTATION.
