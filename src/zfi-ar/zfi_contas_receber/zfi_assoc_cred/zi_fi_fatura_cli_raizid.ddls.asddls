...
@EndUserText.label: 'Documentos Faturas Raiz ID'
...
define view entity ZI_FI_FATURA_CLI_RAIZID as select from bsid_view as bsid
                                                         ...
                                                         and _bseg.buzei = bsid.buzei
{
  ...
  key bsid.buzei as Linha,
      cast( '' as kunnr  )           as Cliente,
      _RaizCnpj.RaizId               as RaizId,
      cast( 'X' as boole_d  )        as RaizSN,
