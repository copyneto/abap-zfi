class ZCLFI_CX_FMT_CONSULTA_STATUS_P definition
  public
...
public section.
  ...
  data STANDARD type ZCLFI_EXCHANGE_FAULT_DATA1 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLFI_EXCHANGE_FAULT_DATA1 optional
...
CLASS ZCLFI_CX_FMT_CONSULTA_STATUS_P IMPLEMENTATION.
