class ZCLFI_CX_FMT_CONSULTA_PENDENCI definition
  public
...
public section.
  ...
  data STANDARD type ZCLFI_EXCHANGE_FAULT_DATA2 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLFI_EXCHANGE_FAULT_DATA2 optional
...
CLASS ZCLFI_CX_FMT_CONSULTA_PENDENCI IMPLEMENTATION.
