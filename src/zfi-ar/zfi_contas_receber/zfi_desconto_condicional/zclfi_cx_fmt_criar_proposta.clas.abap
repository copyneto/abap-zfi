class ZCLFI_CX_FMT_CRIAR_PROPOSTA definition
  public
...
public section.
  ...
  data STANDARD type ZCLFI_EXCHANGE_FAULT_DATA5 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLFI_EXCHANGE_FAULT_DATA5 optional
...
CLASS ZCLFI_CX_FMT_CRIAR_PROPOSTA IMPLEMENTATION.
