class ZCLFI_CX_FMT_CONSULTA_PROPOSTA definition
  public
...
public section.
  ...
  data STANDARD type ZCLFI_EXCHANGE_FAULT_DATA6 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLFI_EXCHANGE_FAULT_DATA6 optional
...
CLASS ZCLFI_CX_FMT_CONSULTA_PROPOSTA IMPLEMENTATION.
