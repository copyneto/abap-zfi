class ZCLFI_CX_FMT_PARCELA_AGENDAMEN definition
  public
...
public section.
  ...
  data STANDARD type ZCLFI_EXCHANGE_FAULT_DATA3 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLFI_EXCHANGE_FAULT_DATA3 optional
...
CLASS ZCLFI_CX_FMT_PARCELA_AGENDAMEN IMPLEMENTATION.
