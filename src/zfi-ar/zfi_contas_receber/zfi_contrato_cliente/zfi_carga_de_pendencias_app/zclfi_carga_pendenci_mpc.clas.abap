class ZCLFI_CARGA_PENDENCI_MPC definition
  public
...
CLASS ZCLFI_CARGA_PENDENCI_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZFI_CARGA_PENDENCIAS_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCLFI_CARGA_PENDENCI_MPC=>TS_UPLOAD' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220706182220'.                  "#EC NOTEXT
