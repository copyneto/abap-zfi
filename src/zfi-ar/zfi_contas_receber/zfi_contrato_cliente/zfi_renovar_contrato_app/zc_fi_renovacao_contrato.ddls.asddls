@EndUserText.label: 'Renovação de Contrato - Projection'
@AccessControl.authorizationCheck: #CHECK
@Metadata.allowExtensions: true
define root view entity ZC_FI_RENOVACAO_CONTRATO
  as projection on ZI_FI_RENOVACAO_CONTRATO
{
  key DocUuidH,
  ...
  key Aditivo,
      ...
      @Consumption.valueHelpDefinition: [{
            entity: {
                name: 'ZI_FI_VH_SITUACAO_CONTRATO',
                element: 'Texto'
            }
        }]
      @ObjectModel.text.element: ['SituacaoTexto']
