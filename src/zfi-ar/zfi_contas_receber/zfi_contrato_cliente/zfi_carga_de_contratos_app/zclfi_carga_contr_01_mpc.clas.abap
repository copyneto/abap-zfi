...
model->set_schema_namespace( 'ZFI_CARGA_CONTRATOS_SRV' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCLFI_CARGA_CONTR_01_MPC=>TS_UPLOAD' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20220630115211'.                  "#EC NOTEXT
