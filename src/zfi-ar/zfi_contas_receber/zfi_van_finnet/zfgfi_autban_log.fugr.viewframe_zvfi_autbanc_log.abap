*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVFI_AUTBANC_LOG
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVFI_AUTBANC_LOG    .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVFI_AUTBANC_LOG'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVFI_AUTBANC_LOG_EXTRACT
TOTAL = ZVFI_AUTBANC_LOG_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVFI_AUTBANC_LOG'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVFI_AUTBANC_LOG-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFI_AUTBANC_LOG_EXTRACT
TOTAL = ZVFI_AUTBANC_LOG_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVFI_AUTBANC_LOG-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVFI_AUTBANC_LOG'
...
TOTAL = ZVFI_AUTBANC_LOG_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVFI_AUTBANC_LOG-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVFI_AUTBANC_LOG-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVFI_AUTBANC_LOG'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVFI_AUTBANC_LOG-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVFI_AUTBANC_LOG_EXTRACT
TOTAL = ZVFI_AUTBANC_LOG_TOTAL
