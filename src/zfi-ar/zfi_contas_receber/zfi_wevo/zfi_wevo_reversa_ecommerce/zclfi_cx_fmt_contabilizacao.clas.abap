class ZCLFI_CX_FMT_CONTABILIZACAO definition
  public
...
public section.
  ...
  data STANDARD type ZCLFI_EXCHANGE_FAULT_DATA7 read-only .
  ...
  methods CONSTRUCTOR
    importing
      ...
      !STANDARD type ZCLFI_EXCHANGE_FAULT_DATA7 optional
...
CLASS ZCLFI_CX_FMT_CONTABILIZACAO IMPLEMENTATION.
