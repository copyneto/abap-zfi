@AbapCatalog.sqlViewName: 'ZAVACONT2'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Agrupamento com as contas'
define view ZI_FI_GRP_AREA_AVA_CONTAS2
  as select from    anla                   as _A

    left outer join ZI_FI_GRP_AREA_AVA_ALL as _Ava     on  _Ava.bukrs = _A.bukrs
